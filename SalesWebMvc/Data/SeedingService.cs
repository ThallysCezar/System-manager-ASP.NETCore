...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r7 = new SalesRecord(7, new DateTime(2018, 09, 29), 1500.0, SaleStatus.Billed, s8);
            ...
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 09, 22), 2100.0, SaleStatus.Billed, s8);
            ...
            SalesRecord r18 = new SalesRecord(18, new DateTime(2018, 09, 3), 1500.0, SaleStatus.Billed, s8);
            ...
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 09, 16), 3400.0, SaleStatus.Billed, s7);
            SalesRecord r24 = new SalesRecord(24, new DateTime(2018, 09, 18), 2100.0, SaleStatus.Billed, s2);
            SalesRecord r25 = new SalesRecord(25, new DateTime(2018, 09, 23), 1100.0, SaleStatus.Billed, s7);
            ...
            SalesRecord r29 = new SalesRecord(29, new DateTime(2018, 09, 29), 4100.0, SaleStatus.Billed, s7);
